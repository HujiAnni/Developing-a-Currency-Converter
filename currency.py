...
import introcs
APIKEY='WtXfpkV4vrsh8nNnLj4AZgTfJgacdgVhNPdPKuvvKTge'
...
def get_dst(json): 
    ...
    idx=introcs.find_str(json,"dst")
    dst=first_inside_quotes(json[idx+5:])
    return dst
...
def iscurrency(currency):
    ...
    assert type(currency)==str and len(currency)==3, 'Precondition violation'
